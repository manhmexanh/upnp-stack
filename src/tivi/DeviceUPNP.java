...
public class DeviceUPNP extends JFrame implements PropertyChangeListener, ActionListener{
    ...
    private void init()
    {
        ...
        but = new JButton("TUNR ON/ TURN OFF"); but.setBounds(50, 300, 300, 50);
        AutoResizeIcon.setIcon(label, "img/tv-off.png");
    ...
    final String friendlyName = "tivi";
    ...
    public void propertyChange(PropertyChangeEvent pce) {
        if (pce.getPropertyName().equals("status")) {
            ...
            if(status) AutoResizeIcon.setIcon(label, "img/tv-on.png");
            else AutoResizeIcon.setIcon(label, "img/tv-off.png");
            repaint();
    ...
    protected Icon createDefaultDeviceIcon() {
        try {
            File file = new File("src/img/tv-off.png");
